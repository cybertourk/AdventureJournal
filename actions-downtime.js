...
const DOWNTIME_ACTIVITIES = {
    ...
    "Gambling": { icon: "fa-dice", desc: "Play games of chance to win or lose money.", action: "comingSoon" },
    "Pit Fighting": { icon: "fa-hand-fist", desc: "Engage in combat to win prize money.", action: "comingSoon" },
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="number" id="dt-buy-mod" value="0" class="w-full p-2 border border-[#d4c5a9] rounded-r-sm text-sm font-bold text-stone-900 outline-none focus:border-blue-600 bg-white shadow-inner">
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-5 sm:p-6 overflow-y-auto custom-scrollbar flex-grow bg-[#fdfbf7]">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <span class="bg-stone-200 border border-r-0 border-[#d4c5a9] px-3 py-2 text-sm font-bold text-stone-600 rounded-l-sm">+</span>
                                <input type="number" id="dt-carouse-mod" value="0" class="w-full p-2 border border-[#d4c5a9] rounded-r-sm text-sm font-bold text-stone-900 outline-none focus:border-blue-600 bg-white shadow-inner">
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-5 sm:p-6 overflow-y-auto custom-scrollbar flex-grow bg-[#fdfbf7]">
                    ...
                    <div class="mb-5 bg-white p-4 border border-[#d4c5a9] rounded-sm shadow-sm transition-all duration-300">
                        ...
                        <div id="dt-craft-nonmagical-fields" class="mb-4">
                            ...
                            <input type="number" id="dt-craft-cost" min="1" value="50" oninput="window.appActions.updateCraftingMath()" class="w-full p-2 border border-[#d4c5a9] rounded-sm text-sm font-bold text-stone-900 outline-none focus:border-blue-600 bg-stone-50 shadow-inner">
...
export const executeCrime = async () => {
    ...
    // Complication logic matching Xanathar's and the Foundry Macro precisely
    ...
    const dateKey = `${igY}-${igM}-${igD}`;
    const newNote = {
        id: generateId(), text: noteText, authorId: myUid, visibility: { mode: 'hidden', visibleTo: [] }, // Default to Hidden since Crime is highly illegal and private!
        timestamp: Date.now(), duration: 5, repeatsYearly: false, category: 'Downtime'
    };
