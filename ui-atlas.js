export function getAtlasHTML(state) {
    ...
    <div class="animate-in fade-in duration-300 w-full max-w-6xl mx-auto flex flex-col h-[calc(100vh-120px)] sm:h-[calc(100vh-140px)] relative">
        ...
        <!-- Map Area -->
        <div class="flex-grow relative bg-[#1c1917] overflow-hidden rounded-b-sm border-x-2 border-b-2 border-stone-800 shadow-[0_15px_40px_rgba(0,0,0,0.7)]" id="atlas-wrapper">
